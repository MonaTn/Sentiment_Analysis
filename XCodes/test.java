...
public class test {
	...
	public static void main(String[] args) throws Exception {
		...
		//**
		File resultFileOfDocuments = new File ("Result/result_test_.csv");
		...
		for (Document document : trainingDocumentsSet) {
			...
			if (!caseSolution.isEmpty()) {
				...
				//**
				document.setPolarity(! truePolarityOfTrainingSet);
				bufferWrite.write(document.getName()+" , "+document.getPolarity());
				bufferWrite.newLine();
				//**
			}
		}
...
//		printlnOpinionatedMap(opinionatedWords);
		pw.println("Lexicon is "+lexicon.toString()+"   Score is : " + score);
