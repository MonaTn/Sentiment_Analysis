...
public class ExteraMethods {
	...
	public static void newP(String fileName) throws IOException {
	...
	public DocumentPreprocessor documentPreprocessor(Document document)
			throws IOException {
	...
	public DocumentPreprocessor documentPreprocessor1(Document document) {
		return new DocumentPreprocessor(document.getAbsoluteFileName());
	}
	public synchronized List<Tree> synchron(List<Tree> trees) {
		synchronized (trees) {
